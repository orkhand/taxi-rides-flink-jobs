...
public class GeoUtils {
  ...
  /**
   * Checks if a location specified by longitude and latitude values is within the geo boundaries of
   * New York City.
   *
   ...
   * area of NYC. The grid cells are roughly 100 x 100 m and sequentially number from north-west to
